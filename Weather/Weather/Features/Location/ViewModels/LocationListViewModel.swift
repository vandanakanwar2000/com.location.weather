...
struct LocationListViewModel {
    ...
    let storageManager = SearchHistoryManager()
    ...
    func weatherListCellModel(model: CurrentWeather?, cityName: String?) -> WeatherListViewModel {
        guard let model = model else { return WeatherListViewModel(temperatureLabelText: LocalizedString.initialValue.description,
