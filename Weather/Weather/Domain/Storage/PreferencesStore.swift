...
public struct Preference {
    ...
    public enum Store {
        ...
        case secure
        /// Access preferences in the background even when the device in locked
        case backgroundAccess
    ...
    /**
     ...
     ```
     extension Key {
     static let accountNameKey = Key(rawValue: "au.com.westpac.native.ACCOUNT_NAME_KEY"
     }
     ```
     */
